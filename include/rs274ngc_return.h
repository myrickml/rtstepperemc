...
#define NCE_BAD_CHARACTER_USED _("Bad character used")
...
#define NCE_BUG_CODE_NOT_G40_G41_OR_G42 _("Bug code not g40 g41 or g42")
#define NCE_BUG_CODE_NOT_G43_OR_G49 _("Bug code not g43 or g49")
...
#define NCE_BUG_CODE_NOT_G93_OR_G94 _("Bug code not g93 or g94")
...
#define NCE_CANNOT_CHANGE_UNITS_WITH_CUTTER_RADIUS_COMP _("Cannot change units with cutter radius comp")
...
#define NCE_CANNOT_MOVE_ROTARY_AXES_DURING_PROBING _("Cannot move rotary axes during probing")
...
#define NCE_CANNOT_PROBE_IN_INVERSE_TIME_FEED_MODE _("Cannot probe in inverse time feed mode")
...
#define NCE_CANNOT_TURN_CUTTER_RADIUS_COMP_ON_OUT_OF_XY_PLANE _("Cannot turn cutter radius comp on out of xy plane")
#define NCE_CANNOT_TURN_CUTTER_RADIUS_COMP_ON_WHEN_ON _("Cannot turn cutter radius comp on when on")
#define NCE_CANNOT_USE_A_WORD _("Cannot use a word")
...
#define NCE_CANNOT_USE_B_WORD _("Cannot use b word")
#define NCE_CANNOT_USE_C_WORD _("Cannot use c word")
...
#define NCE_CANNOT_USE_XZ_PLANE_WITH_CUTTER_RADIUS_COMP _("Cannot use xz plane with cutter radius comp")
#define NCE_CANNOT_USE_YZ_PLANE_WITH_CUTTER_RADIUS_COMP _("Cannot use yz plane with cutter radius comp")
#define NCE_COMMAND_TOO_LONG _("Command too long")
#define NCE_CONCAVE_CORNER_WITH_CUTTER_RADIUS_COMP _("Concave corner with cutter radius comp")
#define NCE_COORDINATE_SYSTEM_INDEX_PARAMETER_5220_OUT_OF_RANGE _("Coordinate system index parameter 5220 out of range")
#define NCE_CURRENT_POINT_SAME_AS_END_POINT_OF_ARC _("Current point same as end point of arc")
#define NCE_CUTTER_GOUGING_WITH_CUTTER_RADIUS_COMP _("Cutter gouging with cutter radius comp")
#define NCE_D_WORD_WITH_NO_G41_OR_G42 _("D word with no g41 or g42")
...
#define NCE_I_WORD_WITH_NO_G2_OR_G3_G76_OR_G87_TO_USE_IT _("I word with no g2, g3, g87, or g43 to use it")
...
#define NCE_J_WORD_WITH_NO_G2_OR_G3_G76_OR_G87_TO_USE_IT _("J word with no g2, g3 or g87 to use it")
...
#define NCE_K_WORD_WITH_NO_G2_OR_G3_G76_OR_G87_TO_USE_IT _("K word with no g2, g3, g33, g33.1, g76, g87, or g43.1 to use it")
#define NCE_L_WORD_WITH_NO_CANNED_CYCLE_OR_G10 _("L word with no canned cycle, g10, or g76 to use it")
...
#define NCE_LINE_NUMBER_GREATER_THAN_99999 _("Line number greater than 99999")
#define NCE_LINE_WITH_G10_DOES_NOT_HAVE_L2 _("Line with g10 does not have l2")
...
#define NCE_NO_DIGITS_FOUND_WHERE_REAL_NUMBER_SHOULD_BE _("No digits found where real number should be")
...
#define NCE_Q_WORD_WITH_NO_G83_OR_M66 _("Q word with no g83 or m66")
...
#define NCE_RADIUS_TO_END_OF_ARC_DIFFERS_FROM_RADIUS_TO_START _("Radius to end of arc differs from radius to start")
#define NCE_RADIUS_TOO_SMALL_TO_REACH_END_POINT _("Radius too small to reach end point")
#define NCE_REQUIRED_PARAMETER_MISSING _("Required parameter missing")
#define NCE_SELECTED_TOOL_SLOT_NUMBER_TOO_LARGE _("Selected tool slot number too large")
...
#define NCE_G33_NOT_SUPPORTED _("G33 not supported")
#define NCE_CANNED_CYCLES_NOT_SUPPORTED _("Canned cycles not supported")
...
#define NCE_RETURN_OUTSIDE_OF_SUBROUTINE _("Return outside of subroutine")
