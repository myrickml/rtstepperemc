...
struct CANON_POSITION
{
   ...
   {
      return (x == o.x && y == o.y && z == o.z && a == o.a && b == o.b && c == o.c && u == o.u && v == o.v && w == o.v);
   }
   bool operator!=(const CANON_POSITION & o) const
   {
      return (x != o.x || y != o.y || z != o.z || a != o.a || b != o.b || c != o.c || u != o.u || v != o.v || w != o.v);
...
extern void SET_ORIGIN_OFFSETS(double x, double y, double z, double a, double b, double c, double u, double v, double w);
...
extern void STRAIGHT_PROBE(int lineno, double x, double y, double z, double a, double b, double c, double u, double v, double w, unsigned char probe_type);
...
/* Tool Functions */
extern void SET_TOOL_TABLE_ENTRY(int pocket, int toolno, EmcPose offset, double diameter, double frontangle, double backangle, int orientation);
